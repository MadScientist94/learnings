...
public class QuartzScheduler {  
  ...
  private static final String NAME_OF_JOB = "getBulk";  
  private static final String NAME_OF_GROUP = "snmp";  
  private static final String NAME_OF_TRIGGER = "quaterPerHour";  
  ...
  private static void scheduleJob(Trigger triggerNew) throws Exception {  
      ...
      JobDetail jobInstance = JobBuilder.newJob(Recorder.class).withIdentity(NAME_OF_JOB, NAME_OF_GROUP).build();  
